...
const SignIn = () => { 
  let {isUserLoggedIn , setIsUserLoggedIn} =useAuth()
  ...
  return (
    <>
     <h2 className="text-center fw-bold pt-4 mb-2 fg1 ">Login</h2>
        ...
        <p className="text-center mt-3 pb-4"> Don't have an Account? <Link to ="/signup" className="text-white text-decoration-none"> Register</Link> </p>
